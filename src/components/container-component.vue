...
watch(() => userWallpaper.value, (newWallpaper) => {
  updateBackground(newWallpaper);
}, { immediate: true });
</script>

<template>
  <div class="img_container relative flex flex-col items-center justify-center w-full h-screen overflow-hidden" ref="container">
